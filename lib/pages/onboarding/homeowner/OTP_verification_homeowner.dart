...
class OTPVerificationHomeOwnerPage extends StatefulWidget {
  const OTPVerificationHomeOwnerPage({Key? key}) : super(key: key);

  @override
  State<OTPVerificationHomeOwnerPage> createState() =>
      _MyOTPVerificationomeOwnerPageState();
}

class _MyOTPVerificationomeOwnerPageState
    extends State<OTPVerificationHomeOwnerPage> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              BigButtonWidget(text: "Send Code", page: ReviewOnboardingHomeOwnerPage()),
            ],
          ),
        ),
      ),
